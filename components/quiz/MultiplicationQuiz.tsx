...
const MultiplicationQuiz: React.FC = () => {
    ...
    const generateQuestion = () => {
        ...
        setOptions(shuffleArray([answer, ...wrongOptions]));
    ...
    const handleAnswer = (selectedAnswer: number) => {
        ...
        if (selectedAnswer === question?.answer) {
            ...
            setFeedback({message: `Opa! A resposta era ${question?.answer}`, type: 'incorrect'});
        }
    };
    
    const burgerParts = useMemo(() => ['🍕', '🌭', '🥪', '🌮', ' B', 'C'], []);
        ...
        <div className="bg-[#FEEFCE] p-6 md:p-10 rounded-2xl shadow-lg border-4 border-amber-300 w-full max-w-2xl mx-auto">
            ...
            <div className="text-center mb-8">
                <p className="text-3xl md:text-5xl font-bold text-amber-800 flex justify-center items-center space-x-4">
                    ...
                    <span className="text-4xl text-blue-500">{questionEmoji}</span>
                    <span>=</span>
